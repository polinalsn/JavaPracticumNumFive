...
public class thirteen {
    public static void recursion() {
        ...
        if (n > 0) { // Проверяем, если 0 выходим из рекурсии, иначе
            System.out.println(n); // Отправляем в поток вывод текущее число - оно нечетное п осчету
            int m = in.nextInt(); // Вводим следующие число в последовательности, оно будет четным пл счету
